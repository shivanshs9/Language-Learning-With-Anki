...
document.addEventListener("DOMContentLoaded", function () {
	...
	chrome.storage.local.get('ankiConnectUrl', ({ ankiConnectUrl }) => {
		...
		Promise.all([
			...
			fetchOptions('ankiSentenceReadingSelected', url, 'modelFieldNames', { "modelName": model_Name_value })
			...
			submit_button.addEventListener('click', (e) => {
				Promise.all([
					...
					saveOption('ankiSentenceReadingSelected'),
